...
@implementation HKLocationManager


+ (HKLocationManager *)shareLocation{
    ...
    [geocoder reverseGeocodeLocation:newLocation completionHandler:^(NSArray *placemarks,NSError *error)
     {
         if (placemarks.count > 0) {
             ...
             _lastCity = [NSString stringWithFormat:@"%@",placemark.administrativeArea];
