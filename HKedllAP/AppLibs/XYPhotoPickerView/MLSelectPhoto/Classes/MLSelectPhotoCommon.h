...
#define MLUIColorFromRGB(rgbValue) [UIColor colorWithRed:((float)((rgbValue & 0xFF0000) >> 16))/255.0 \
green:((float)((rgbValue & 0xFF00) >> 8))/255.0 \
blue:((float)(rgbValue & 0xFF))/255.0 alpha:1.0]

// Navigation Color
#define DefaultNavbarTintColor MLUIColorFromRGB(0x2f3535)
#define DefaultNavTintColor MLUIColorFromRGB(0xd5d5d5)
#define DefaultNavTitleColor MLUIColorFromRGB(0xd5d5d5)
