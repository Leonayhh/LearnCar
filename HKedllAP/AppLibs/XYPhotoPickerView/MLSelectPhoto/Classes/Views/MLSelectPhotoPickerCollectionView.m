...
- (UICollectionViewCell *) collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(indexPath.item == 0 && self.topShowPhotoPicker){
        ...
        if (self.isRecoderSelectPicker) {
            ...
            {
                MLSelectPhotoAssets *asset2=self.dataArray[indexPath.item];
                
                if ([asset isKindOfClass:[MLSelectPhotoAssets class]]&&[asset.asset.defaultRepresentation.url isEqual:asset2.asset.defaultRepresentation.url])
                {
