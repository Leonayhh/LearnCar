...
//按钮点击委托对象
@property(nonatomic,weak)id<UrLImageButtonDelegate> uBdelegate;
...
@property (nonatomic,assign)BOOL hideTitleBar;//是否隐藏标题
@property (nonatomic,strong) NSTimer *timer; // Don't forget set valid when not in front 
@property (nonatomic,weak)id<ValueClickDelegate> vDelegate;
/**
