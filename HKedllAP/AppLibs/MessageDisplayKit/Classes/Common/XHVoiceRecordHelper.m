...
- (void)stopRecordingWithStopRecorderCompletion:(XHStopRecorderCompletion)stopRecorderCompletion {
    ...
    //沙盒路径
    // /var/mobile/Containers/Data/Application/A4FC8771-3C62-42BC-AA06-83C514C8B73D/Library/Caches201512251714.wav
    //转换成amr格式
    self.amrPath = [VoiceConverter wavToAmr:_recordPath];
    
    if (self.amrPath!=nil)
    {
        //yes
        if ([XHVoiceCommonHelper deleteFileAtPath:_recordPath])
        {
